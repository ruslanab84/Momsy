...
extension Color {
    static let bbCream     = Color(bbHex: "FFF6EC")
    static let bbCreamSoft = Color(bbHex: "FFFAF2")
    static let bbCard      = Color.white
    static let bbInk       = Color(bbHex: "3D2A20")
    static let bbInkSoft   = Color(bbHex: "6B5446")
    static let bbInkMute   = Color(bbHex: "A89484")
            ...
            HStack(spacing: 6) {
                ForEach(chips.indices, id: \.self) { i in
                    Text(chips[i])
                        ...
                        .padding(.vertical, 8)
                        .background(i == selected ? Color.bbInk : Color.bbCard)
                        .clipShape(Capsule())
                        .bbShadowSoft()
                }
            }
