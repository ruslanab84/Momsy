...
/// Builds a per-language string map. Argument order mirrors `L10n.s`: en, ru, de, es, fr, pt.
private func loc(_ en: String, _ ru: String, _ de: String, _ es: String, _ fr: String, _ pt: String) -> [Language: String] {
    [.english: en, .russian: ru, .german: de, .spanish: es, .french: fr, .portuguese: pt]
}
...
extension DevelopmentLeap {
    ...
    DevelopmentLeap(
        ...
        names: loc("World of Senses", "Мир ощущений", "Welt der Sinne", "Mundo de los sentidos", "Monde des sensations", "Mundo dos sentidos"),
    ...
    DevelopmentLeap(
        ...
        names: loc("World of Patterns", "Мир узоров", "Welt der Muster", "Mundo de los patrones", "Monde des motifs", "Mundo dos padrões"),
    ...
    DevelopmentLeap(
        ...
        names: loc("Smooth Transitions", "Плавные движения", "Fließende Bewegungen", "Movimientos suaves", "Mouvements fluides", "Movimentos suaves"),
    ...
    DevelopmentLeap(
        ...
        names: loc("World of Events", "Мир событий", "Welt der Ereignisse", "Mundo de los acontecimientos", "Monde des événements", "Mundo dos acontecimentos"),
    ...
    DevelopmentLeap(
        ...
        names: loc("Relationships", "Отношения", "Beziehungen", "Relaciones", "Relations", "Relações"),
    ...
    DevelopmentLeap(
        ...
        names: loc("Categories", "Категории", "Kategorien", "Categorías", "Catégories", "Categorias"),
