...
struct L10n {
    ...
    func leapNormalLabel(name: String) -> String { s("«\(name)» — a common phase", "«\(name)» — частый этап", "«\(name)» — eine häufige Phase", "«\(name)» — una etapa frecuente", "«\(name)» — une phase fréquente", "«\(name)» — uma fase comum", "「\(name)」——常见阶段") }
    var leapCryingNote: String { s("Crying, poor sleep and wanting to be held are common in this period. If your baby seems unwell, contact your pediatrician.", "Плач, плохой сон и желание быть на руках часто бывают в этот период. Если малыш выглядит нездоровым, обратитесь к педиатру.", "Weinen, schlechter Schlaf und der Wunsch, gehalten zu werden, sind in dieser Zeit häufig. Wenn dein Baby krank wirkt, wende dich an die Kinderarztpraxis.", "El llanto, dormir mal y querer brazos son frecuentes en este periodo. Si tu bebé parece enfermo, consulta a su pediatra.", "Les pleurs, le sommeil agité et le besoin d’être porté sont fréquents à cette période. Si votre bébé semble malade, contactez son pédiatre.", "Choro, sono agitado e vontade de colo são comuns neste período. Se o bebé parecer doente, contacte o pediatra.", "这个阶段常见哭闹、睡不好和想要抱抱。如果宝宝看起来不舒服，请联系儿科医生。") }
    ...
    var leapsAboutText: String {
        s("Leap timing follows a popular theory of infant “regression periods” described by van de Rijt-Plooij and Plooij. It is not a medical standard, and every baby develops at their own pace. Motor milestones in Momsy refer to the WHO Motor Development Study.",
          "Сроки скачков основаны на популярной теории «периодов регрессии» у младенцев, описанной ван де Рейт-Плой и Плоем. Это не медицинский стандарт, и каждый ребёнок развивается в своём темпе. Моторные навыки в Momsy ориентируются на исследование моторного развития ВОЗ.",
          "Der Zeitplan der Schübe folgt einer populären Theorie über „Regressionsphasen“ bei Säuglingen, beschrieben von van de Rijt-Plooij und Plooij. Sie ist kein medizinischer Standard, und jedes Baby entwickelt sich in seinem eigenen Tempo. Motorische Meilensteine in Momsy beziehen sich auf die WHO-Studie zur motorischen Entwicklung.",
          "El calendario de saltos sigue una teoría popular sobre los «periodos de regresión» del bebé, descrita por van de Rijt-Plooij y Plooij. No es un estándar médico y cada bebé se desarrolla a su ritmo. Los hitos motores en Momsy se basan en el Estudio de Desarrollo Motor de la OMS.",
          "Le calendrier des bonds suit une théorie populaire des « périodes de régression » du nourrisson, décrite par van de Rijt-Plooij et Plooij. Ce n’est pas une norme médicale, et chaque bébé se développe à son rythme. Les étapes motrices dans Momsy se réfèrent à l’étude de l’OMS sur le développement moteur.",
          "O calendário dos saltos segue uma teoria popular sobre os «períodos de regressão» do bebé, descrita por van de Rijt-Plooij e Plooij. Não é um padrão médico e cada bebé desenvolve-se ao seu ritmo. Os marcos motores no Momsy referem-se ao Estudo de Desenvolvimento Motor da OMS.",
          "飞跃期的时间依据 van de Rijt-Plooij 和 Plooij 提出的一种流行的婴儿“退化期”理论。它不是医学标准，每个宝宝都有自己的发育节奏。Momsy 中的运动发育里程碑参考世界卫生组织运动发育研究。")
    }
    var leapsDisclaimerShort: String {
        s("A popular theory, not a medical standard", "Популярная теория, а не медицинский стандарт", "Eine populäre Theorie, kein medizinischer Standard", "Una teoría popular, no un estándar médico", "Une théorie populaire, pas une norme médicale", "Uma teoria popular, não um padrão médico", "一种流行理论，并非医学标准")
    }
    ...
    var medicalSourcesTitle: String { s("Sources", "Источники", "Quellen", "Fuentes", "Sources", "Fontes", "来源") }
    var medicalSourcesScreenTitle: String { s("Medical sources", "Медицинские источники", "Medizinische Quellen", "Fuentes médicas", "Sources médicales", "Fontes médicas", "医学资料来源") }
    var medicalSourcesScreenSub: String { s("Where our health information comes from", "Откуда наша информация о здоровье", "Woher unsere Gesundheitsinformationen stammen", "De dónde procede nuestra información de salud", "D’où viennent nos informations de santé", "De onde vem a nossa informação de saúde", "我们的健康信息来源") }
    var medicalDisclaimerTitle: String { s("Not medical advice", "Не медицинская консультация", "Keine medizinische Beratung", "No es consejo médico", "Pas un avis médical", "Não é aconselhamento médico", "非医疗建议") }
    var medicalDisclaimerBody: String {
        s("Momsy provides general information from the sources listed below to help you care for your baby. It does not diagnose conditions or replace your pediatrician. If you are worried about your baby's health, contact a doctor. In an emergency, call your local emergency number.",
          "Momsy предоставляет общую информацию из перечисленных ниже источников, чтобы помочь вам заботиться о малыше. Приложение не ставит диагнозы и не заменяет педиатра. Если вас беспокоит здоровье малыша, обратитесь к врачу. В экстренной ситуации звоните в местную службу экстренной помощи.",
          "Momsy bietet allgemeine Informationen aus den unten aufgeführten Quellen, um dich bei der Pflege deines Babys zu unterstützen. Die App stellt keine Diagnosen und ersetzt nicht die Kinderarztpraxis. Wenn du dir Sorgen um die Gesundheit deines Babys machst, wende dich an eine Ärztin oder einen Arzt. Im Notfall rufe die örtliche Notrufnummer an.",
          "Momsy ofrece información general de las fuentes que se indican abajo para ayudarte a cuidar de tu bebé. No diagnostica enfermedades ni sustituye a su pediatra. Si te preocupa la salud de tu bebé, consulta a un médico. En una emergencia, llama al número de emergencias local.",
          "Momsy fournit des informations générales issues des sources ci-dessous pour vous aider à prendre soin de votre bébé. L’app ne pose pas de diagnostic et ne remplace pas votre pédiatre. Si la santé de votre bébé vous inquiète, contactez un médecin. En cas d’urgence, appelez le numéro d’urgence local.",
          "O Momsy fornece informação geral das fontes indicadas abaixo para ajudar a cuidar do seu bebé. Não faz diagnósticos nem substitui o pediatra. Se estiver preocupado com a saúde do bebé, contacte um médico. Em caso de emergência, ligue para o número de emergência local.",
          "Momsy 提供来自下列来源的一般信息，帮助你照顾宝宝。它不能诊断疾病，也不能替代儿科医生。如果你担心宝宝的健康，请联系医生。紧急情况下，请拨打当地急救电话。")
    }
    var medicalSourcesOpensInSafari: String { s("Opens in Safari", "Откроется в Safari", "Wird in Safari geöffnet", "Se abre en Safari", "S’ouvre dans Safari", "Abre no Safari", "将在 Safari 中打开") }
    var medicalSourcesButtonA11y: String { s("Show sources", "Показать источники", "Quellen anzeigen", "Mostrar fuentes", "Afficher les sources", "Mostrar fontes", "显示来源") }
    ...
    var rolePhotosStatusOnly: String { s("status only", "только статус", "nur Status", "solo estado", "statut uniquement", "apenas estado", "仅状态") }
    ...
    var familyAccessDeniedMessage: String { s("Your family role doesn’t allow this action.", "Ваша роль в семье не позволяет выполнить это действие.", "Deine Familienrolle erlaubt diese Aktion nicht.", "Tu rol familiar no permite esta acción.", "Votre rôle familial ne permet pas cette action.", "A tua função na família não permite esta ação.", "您的家庭角色不允许执行此操作。") }
    var restrictedRoleCannotCreateFamilyMessage: String { s("Only a parent can create a family.", "Создать семью может только родитель.", "Nur ein Elternteil kann eine Familie erstellen.", "Solo un progenitor puede crear una familia.", "Seul un parent peut créer une famille.", "Só um progenitor pode criar uma família.", "只有父母角色可以创建家庭。") }
    ...
    var removedFromFamilyTitle: String { s("Removed from family", "Вы удалены из семьи", "Aus der Familie entfernt", "Eliminado de la familia", "Retiré de la famille", "Removido da família", "已被移出家庭") }
    var removedFromFamilyMessage: String { s("A family admin removed you from the family, so its data is no longer available on this device. A new personal space has been created for you — keep using the app or join a family with a new invite code.", "Администратор удалил вас из семьи, поэтому её данные больше недоступны на этом устройстве. Для вас создано новое личное пространство — продолжайте пользоваться приложением или присоединитесь к семье по новому коду приглашения.", "Ein Familienadmin hat dich aus der Familie entfernt, daher sind deren Daten auf diesem Gerät nicht mehr verfügbar. Ein neuer persönlicher Bereich wurde für dich erstellt — nutze die App weiter oder tritt mit einem neuen Einladungscode einer Familie bei.", "Un administrador te eliminó de la familia, por lo que sus datos ya no están disponibles en este dispositivo. Se ha creado un nuevo espacio personal para ti — sigue usando la app o únete a una familia con un nuevo código de invitación.", "Un administrateur vous a retiré de la famille ; ses données ne sont donc plus disponibles sur cet appareil. Un nouvel espace personnel a été créé pour vous — continuez à utiliser l’app ou rejoignez une famille avec un nouveau code d’invitation.", "Um administrador removeu-te da família, pelo que os seus dados já não estão disponíveis neste dispositivo. Foi criado um novo espaço pessoal para ti — continua a usar a app ou junta-te a uma família com um novo código de convite.", "家庭管理员已将您移出家庭，其数据在本设备上不再可用。已为您创建新的个人空间——您可以继续使用应用，或通过新的邀请码加入家庭。") }
    ...
    var symptomLogTitle: String          { s("Log symptoms", "Записать симптомы", "Symptome erfassen", "Registrar síntomas", "Noter les symptômes", "Registar sintomas", "记录症状") }
    var symptomLogSubtitle: String       { s("Note what you observe to share with your pediatrician", "Отметьте, что вы заметили, чтобы показать педиатру", "Notieren Sie Ihre Beobachtungen für den Kinderarzt", "Anota lo que observas para compartirlo con tu pediatra", "Notez ce que vous observez pour en parler à votre pédiatre", "Anote o que observa para partilhar com o seu pediatra", "记录您观察到的情况，方便告诉儿科医生") }
    var symptomSeverityQuestion: String  { s("How would you rate it?", "Как бы вы это оценили?", "Wie würden Sie es einschätzen?", "¿Cómo lo valorarías?", "Comment l’évalueriez-vous ?", "Como avaliaria?", "您如何评估？") }
    var symptomSeverityMild: String      { s("Mild", "Слабо", "Leicht", "Leve", "Léger", "Ligeiro", "轻微") }
    var symptomSeverityModerate: String  { s("Moderate", "Умеренно", "Mittel", "Moderado", "Modéré", "Moderado", "中等") }
    var symptomSeverityHigh: String      { s("Severe", "Сильно", "Stark", "Fuerte", "Fort", "Forte", "严重") }
    var symptomNotePlaceholder: String   { s("Add details (optional)", "Добавьте подробности (необязательно)", "Details hinzufügen (optional)", "Añade detalles (opcional)", "Ajouter des détails (facultatif)", "Adicionar detalhes (opcional)", "添加详情（可选）") }
    var symptomLogFooter: String         { s("Momsy does not assess symptoms or give medical advice. If you are worried about your baby, contact your pediatrician. In an emergency, call your local emergency number.", "Momsy не оценивает симптомы и не даёт медицинских советов. Если вы беспокоитесь о малыше, обратитесь к педиатру. В экстренной ситуации звоните в местную службу экстренной помощи.", "Momsy bewertet keine Symptome und gibt keinen medizinischen Rat. Wenn Sie sich Sorgen um Ihr Baby machen, wenden Sie sich an Ihren Kinderarzt. Im Notfall rufen Sie die örtliche Notrufnummer an.", "Momsy no evalúa síntomas ni da consejos médicos. Si te preocupa tu bebé, contacta con tu pediatra. En caso de emergencia, llama al número de emergencias local.", "Momsy n’évalue pas les symptômes et ne donne pas de conseils médicaux. Si vous êtes inquiet pour votre bébé, contactez votre pédiatre. En cas d’urgence, appelez le numéro d’urgence local.", "A Momsy não avalia sintomas nem dá conselhos médicos. Se estiver preocupado com o seu bebé, contacte o seu pediatra. Em caso de emergência, ligue para o número de emergência local.", "Momsy 不评估症状，也不提供医疗建议。如果您担心宝宝，请联系儿科医生。紧急情况下，请拨打当地急救电话。") }
    ...
    var vaccinationSourceNote: String {
        s("The schedule shown is adapted from the official source below. This adaptation was not created by that organisation, which is not responsible for its content or accuracy. Regional programs may differ — follow your paediatrician's advice.",
          "Показанный календарь — адаптация официального источника ниже. Эта адаптация создана не этой организацией, и она не несёт ответственности за её содержание и точность. Региональные программы могут отличаться — следуйте рекомендациям педиатра.",
          "Der angezeigte Impfplan ist eine Adaption der unten genannten offiziellen Quelle. Diese Adaption wurde nicht von dieser Organisation erstellt, die nicht für Inhalt oder Richtigkeit verantwortlich ist. Regionale Programme können abweichen — folgen Sie dem Rat Ihrer Kinderärztin oder Ihres Kinderarztes.",
          "El calendario mostrado es una adaptación de la fuente oficial indicada abajo. Esta adaptación no fue creada por dicha organización, que no se hace responsable de su contenido ni de su exactitud. Los programas regionales pueden variar: sigue las indicaciones de tu pediatra.",
          "Le calendrier affiché est une adaptation de la source officielle ci-dessous. Cette adaptation n’a pas été créée par cette organisation, qui n’est pas responsable de son contenu ni de son exactitude. Les programmes régionaux peuvent différer — suivez les conseils de votre pédiatre.",
          "O plano apresentado é uma adaptação da fonte oficial abaixo. Esta adaptação não foi criada por essa organização, que não é responsável pelo seu conteúdo nem pela sua exatidão. Os programas regionais podem variar — siga as indicações do seu pediatra.",
          "所示接种计划改编自下方的官方来源。该改编版本并非由该机构制作，该机构不对其内容或准确性负责。各地区的项目可能不同——请遵循儿科医生的建议。")
    }
    func vaccinationScheduleHint(_ child: String) -> String { s("Schedule for \(child). Official national schedule. Regional programs may differ — confirm with your pediatrician.", "Календарь для \(child). Официальный национальный календарь. Региональные программы могут отличаться — уточните у педиатра.", "Impfplan für \(child). Offizieller nationaler Impfplan. Regionale Programme können abweichen — sprechen Sie mit Ihrer Kinderärztin oder Ihrem Kinderarzt.", "Calendario de \(child). Calendario nacional oficial. Los programas regionales pueden variar: confírmalo con tu pediatra.", "Calendrier de \(child). Calendrier national officiel. Les programmes régionaux peuvent différer — vérifiez avec votre pédiatre.", "Plano de \(child). Plano nacional oficial. Os programas regionais podem variar — confirme com o seu pediatra.", "\(child)的接种计划。官方国家接种计划。各地区项目可能不同——请与儿科医生确认。") }
    var vaccinationScheduleReadOnlyHint: String { s("Only parents can change this.", "Изменить могут только родители.", "Nur Eltern können dies ändern.", "Solo los padres pueden cambiarlo.", "Seuls les parents peuvent modifier ce réglage.", "Só os pais podem alterar isto.", "只有父母可以更改此设置。") }
    var vaccinationSchedulePremiumHint: String { s("Choosing a country schedule is part of Premium.", "Выбор календаря страны доступен в Premium.", "Die Wahl eines Länder-Impfplans ist Teil von Premium.", "Elegir el calendario de un país forma parte de Premium.", "Le choix d’un calendrier national fait partie de Premium.", "Escolher o plano de um país faz parte do Premium.", "选择国家接种计划属于 Premium 功能。") }
    func vaccinationFromSchedule(_ name: String) -> String { s("From schedule: \(name)", "Из графика: \(name)", "Aus Impfplan: \(name)", "Del calendario: \(name)", "Du calendrier : \(name)", "Do plano: \(name)", "来自接种计划：\(name)") }
    var vaccinationScheduleName_who: String { s("International (WHO)", "Международный (ВОЗ)", "International (WHO)", "Internacional (OMS)", "International (OMS)", "Internacional (OMS)", "国际（世卫组织）") }
    var vaccinationScheduleName_usAAP: String { s("United States (AAP)", "США (AAP)", "USA (AAP)", "Estados Unidos (AAP)", "États-Unis (AAP)", "Estados Unidos (AAP)", "美国（AAP）") }
    var vaccinationScheduleName_caNational: String { s("Canada (PHAC)", "Канада (PHAC)", "Kanada (PHAC)", "Canadá (PHAC)", "Canada (ASPC)", "Canadá (PHAC)", "加拿大（PHAC）") }
    var vaccinationScheduleName_deSTIKO: String { s("Germany (STIKO)", "Германия (STIKO)", "Deutschland (STIKO)", "Alemania (STIKO)", "Allemagne (STIKO)", "Alemanha (STIKO)", "德国（STIKO）") }
    var vaccinationScheduleName_frNational: String { s("France", "Франция", "Frankreich", "Francia", "France", "França", "法国") }
    var vaccinationScheduleName_itNational: String { s("Italy", "Италия", "Italien", "Italia", "Italie", "Itália", "意大利") }
    var vaccinationScheduleName_esNational: String { s("Spain (SNS)", "Испания (SNS)", "Spanien (SNS)", "España (SNS)", "Espagne (SNS)", "Espanha (SNS)", "西班牙（SNS）") }
    var vaccinationScheduleName_brNational: String { s("Brazil (PNI)", "Бразилия (PNI)", "Brasilien (PNI)", "Brasil (PNI)", "Brésil (PNI)", "Brasil (PNI)", "巴西（PNI）") }
    var vaccinationScheduleName_ukNHS: String { s("United Kingdom (NHS)", "Великобритания (NHS)", "Vereinigtes Königreich (NHS)", "Reino Unido (NHS)", "Royaume-Uni (NHS)", "Reino Unido (NHS)", "英国（NHS）") }
    var vaccinationScheduleName_ruNational: String { s("Russia (National)", "Россия (национальный)", "Russland (national)", "Rusia (nacional)", "Russie (national)", "Rússia (nacional)", "俄罗斯（国家）") }
    ...
    var epdsSafetyTitle: String       { s("Please get help now", "Пожалуйста, обратитесь за помощью сейчас", "Bitte holen Sie sich jetzt Hilfe", "Busca ayuda ahora", "Demandez de l’aide maintenant", "Procure ajuda agora", "请立即寻求帮助") }
    var epdsSafetyMessage: String     { s("Contact your healthcare provider immediately. If you may harm yourself or cannot stay safe, call your local emergency services or go to the nearest emergency department now.",
                                          "Немедленно свяжитесь с врачом. Если вы можете причинить себе вред или не можете оставаться в безопасности, позвоните в местную экстренную службу или прямо сейчас обратитесь в ближайшее отделение неотложной помощи.",
                                          "Wenden Sie sich sofort an eine medizinische Fachkraft. Wenn Sie sich möglicherweise selbst verletzen oder nicht sicher bleiben können, rufen Sie den örtlichen Notruf an oder gehen Sie jetzt in die nächste Notaufnahme.",
                                          "Contacta inmediatamente con un profesional sanitario. Si crees que podrías hacerte daño o no puedes mantenerte a salvo, llama a los servicios de emergencia locales o acude ahora al servicio de urgencias más cercano.",
                                          "Contactez immédiatement un professionnel de santé. Si vous risquez de vous faire du mal ou ne pouvez pas rester en sécurité, appelez les services d’urgence locaux ou rendez-vous immédiatement aux urgences les plus proches.",
                                          "Contacte imediatamente um profissional de saúde. Se sentir que pode fazer mal a si própria ou que não consegue manter-se em segurança, ligue para os serviços de emergência locais ou dirija-se agora ao serviço de urgência mais próximo.",
                                          "请立即联系医疗专业人员。如果您可能伤害自己或无法确保自身安全，请立即拨打当地急救电话或前往最近的急诊室。") }
    var epdsFindLocalSupport: String  { s("Find crisis support in your region", "Найти кризисную помощь в вашем регионе", "Krisenhilfe in Ihrer Region finden", "Buscar ayuda para crisis en tu región", "Trouver une aide de crise dans votre région", "Encontrar apoio de crise na sua região", "查找您所在地区的危机援助") }
